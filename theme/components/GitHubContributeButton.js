function GitHubContributeButton(navigationPath, isFullPath = false) {
  return /* html */`
  <a 
    target="_blank" 
    rel="noopener noreferer" 
    class="github-contribute-button blog dynamic-url shadow" 
    href="${isFullPath ? isFullPath : `https://github.com/abelljs/abell-website/tree/main/content/${navigationPath}`}" 
    data-size="large"
  >
